  $(document).ready(function() {
      ...
      function first_load() {
          TweenMax.from('.hero-little', 0.4, {
              opacity: 0,
              y: -40,
              delay: .7
          });
          TweenMax.from('.hero-title', 0.4, {
              opacity: 0,
              y: -30,
              delay: .9
          });
          //  TweenMax.from('.hero .arrow', 0.4,{opacity:0, y:-40, delay:1.2}); 
          TweenMax.from('.work-hero .title', 0.4, {
              opacity: 0,
              y: 40,
              delay: .6
          });
          TweenMax.from('.hero-subtitle', 0.4, {
              opacity: 0,
              y: 40,
              delay: .8
          });
          TweenMax.from('.section-down-arrow.subpage', 0.4, {
              opacity: 0,
              y: 40,
              delay: 1
          });
      ...
      function ZoomImage() {
          ...
          function animotion(fromthere, tothere) {
              ...
              TweenLite.set([fromthere, tothere], {
                  visibility: "hidden"
              });
              TweenLite.set(clone, {
                  position: "absolute",
